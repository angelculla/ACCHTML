...
- acchtml is a class derived from WebServer that adds methods to generate HTML code
...
void cgi_index() {                                                   // This is de default page
  ...
  html.beginpage("",0);                                                  // begins the html code without refresh by time
...
void cgi_formok() {                                                  // This cgi is called by the submit of the form
  input1=html.arg("v1");                                      // saves the received data into variables input1, input2 and pwd
  input2=html.arg("v2");
  pwd=html.arg("PWD");
...
void cgi_404() {                                                     // cgi called by error 404 (page not found)
  html.send(404, "text/plain", "This page does not exist!");
}



void cgi_graph_google() {                                            // cgi called when the navigator asks for the file graph_google
  html.send_P(200,"image/png",graph_google,sizeof(graph_google));
}
